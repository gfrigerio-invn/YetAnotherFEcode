        ...
        function [t, q_history] = solve(obj, tmax, dt, q0, qd0, F_handle, varargin)
            ...
            if is_nonlinear
                ...
                elseif strcmpi(args.ModelType, 'Rubin')
                    ...
                    error('ModelType non recognized. Use ''FOM'', ''MC'' or ''Rubin''.');
                end
                
                % ==============================================================
                % INIZIALIZZAZIONE IMPOSTAZIONI GENERALIZED-ALPHA
                % ==============================================================
                tic;
                % Creazione dell'istanza usando la classe nativa di YAFEC
                TI = GeneralizedAlpha('timestep', dt, ...
                                      'rho_inf', 0.7, ...   
                                      'linear', false, ...
                                      'ATS', true, ...    
                                      'hmin', 1e-10);
                                  
                TI.tol = 1e-6;      % Tolleranza di convergenza per Newton-Raphson
                TI.MaxNRit = 15;    % Numero massimo di iterazioni NR per passo
                
                % Esecuzione dell'integrazione nel tempo
