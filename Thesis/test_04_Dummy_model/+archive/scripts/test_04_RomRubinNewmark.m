...
%% --- 5. ROM TRANSIENT (RUBIN) ---
fprintf('\n--- Starting ROM Transient ---\n');
% Contact DoF Mapping
...
% Launch ROM Solver
solverRubin = TransientSolver(Mr_rubin, Kr_rubin, Cr_rubin);
[t_rubin, q_rom_rubin] = solverRubin.solve(tmax, dt, q0_rubin, qd0_rubin, F_rubin_handle, ...
...
save(fullfile(save_dir, 'ROM_Rubin_Light.mat'), 't_rubin', 'y_spia_rom_rubin', 'y_parete_rom_rubin');
...
y_spia_rom_interp = interp1(t_rubin, y_spia_rom_rubin, t_fom_newmark, 'linear', 'extrap');
